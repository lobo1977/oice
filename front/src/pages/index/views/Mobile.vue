<template>
  <div style="margin:0 auto;max-width:600px;padding:15px;">
    <group>
      <x-input ref="inpBindMobile" placeholder="输入手机号码" v-model="mobile" :max="11" :required="true"
         type="tel" is-type="china-mobile" @on-click-error-icon="mobileError" :should-toast-error="false" @on-enter="bind" @on-change="validatedForm">
